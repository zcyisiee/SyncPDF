...
class StylesAndFormulas:
    ...
    def is_formulas_font(self, font_name: str) -> bool:
        pattern2 = (
            ...
            r"|.*Times-Italic.*"
            r"|.*Times-BoldItalic.*"
            r"|.*PalatinoLTStd-Italic.*"
            r"|.*PalatinoLTStd-MediumItalic.*"
            r"|.*Times New Roman,Italic.*"
            r"|.*EhrhardtMT-Italic.*"
            r"|.*GillSansMTStd-BookItalic.*"
            r"|.*MedicineSymbols3-Regular.*"
            r"|.*GillSansMTStd-MediumItalic.*"
            r"|.*HardingText-RegularItalic.*"
            r"|.*GraphikNaturel-RegularItalic.*"
            r"|.*HelveticaNeue-LightItalic.*"
            r"|.*HelveticaNeue-BoldItalic.*"
            r"|.*GoudyOldStyleT-Italic.*"
            r"|.*HelveticaNeue-MediumItalic.*"
            r"|.*Symbol.*"
            r"|.*ScalaSansLF-Italic.*"
            r"|.*ScalaLF-Italic.*"
            r"|.*ScalaSansPro-Italic.*"
            r"|.*PetersburgC-Italic.*"
            r"|.*PetersburgC-BoldItalic.*"
            r"|.*ColiseumC-Italic.*"
            r"|.*Gantari-Italic.*"
            r"|.*OptimaLTStd-Italic.*"
            r")$"
        )

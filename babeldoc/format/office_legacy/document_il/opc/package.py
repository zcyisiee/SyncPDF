...
from babeldoc.format.office.document_il.opc.constants import RELATIONSHIP_TYPE as RT
from babeldoc.format.office.document_il.opc.packuri import PACKAGE_URI
...
# from babeldoc.format.office.document_il.opc.parts.coreprops import CorePropertiesPart
...
if TYPE_CHECKING:
    from babeldoc.format.office.document_il.opc.coreprops import CoreProperties
    from babeldoc.format.office.document_il.opc.part import Part
    from babeldoc.format.office.document_il.opc.rel import (
        _Relationship,  # pyright: ignore[reportPrivateUsage]
    )
...
class OpcPackage:
    ...
    def rels(self):
        ...
        return Relationships(PACKAGE_URI.baseURI, PACKAGE_URI)
